# Импорт необходимых классов и констант
...
class Field:
    ...
    # Свойство для получения x-размера поля
    @property
    def x_size(self) -> int:
        return self.__x_size

    # Свойство для получения y-размера поля
    @property
    def y_size(self) -> int:
        return self.__y_size

    # Свойство для получения общего размера поля
    @property
    def size(self) -> int:
